...
#
# ==============================================================================
#  带条件化参数的智能 DD 安装 Debian 脚本 (v6 - 修正解释器)
#
# ==============================================================================
...
echo "  - IP 地址: $IP_CIDR"
echo "  - 网关: $GATEWAY"
echo "  - 最终传递给 debi.sh 的命令: sh debi.sh ${DEBI_ARGS[*]}"
echo "--------------------------------------------------"
...
echo "INFO: 下载完成，开始使用 sh 解释器执行安装..."
# --- 这里是关键修正：明确使用 sh 来执行脚本 ---
sh ./debi.sh "${DEBI_ARGS[@]}" && \
shutdown -r now
