...
#
# ==============================================================================
#  带条件化参数的智能 DD 安装 Debian 脚本 (v7 - 强制使用 bash)
# ==============================================================================
...
echo "  - IP 地址: $IP_CIDR"
echo "  - 网关: $GATEWAY"
echo "  - 最终传递给 debi.sh 的命令: bash debi.sh ${DEBI_ARGS[*]}"
echo "--------------------------------------------------"
...
# --- 这里是关键修正：明确使用 bash 来执行脚本，以获得最大兼容性 ---
bash ./debi.sh "${DEBI_ARGS[@]}" && \
shutdown -r now
